...
3. (optional) Poke us in [#technical_blog](https://coveo.slack.com/messages/technical_blog) or [#opensource](https://coveo.slack.com/messages/opensource) channel on [slack](coveo.slack.com) to join Coveo Organization
