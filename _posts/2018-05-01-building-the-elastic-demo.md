...
title: "Building the Elastic Search Demo, Part 1"
...
Now we can start building the UI, covered in: [Building the Elastic Search Demo, Part 2](/2018/05/01/building-the-elastic-demo-part2).
